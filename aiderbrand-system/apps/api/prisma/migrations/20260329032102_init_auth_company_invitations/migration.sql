-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SYSTEM_ADMIN', 'PROJECT_LEAD', 'DELIVERY_SPECIALIST', 'ACCOUNT_OWNER', 'COLLABORATOR');
...
-- CreateIndex
CREATE INDEX "invitations_email_companyId_status_idx" ON "invitations"("email", "companyId", "status");
