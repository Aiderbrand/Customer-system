...
interface ProjectSettingsSheetProps {
  ...
  onSave: (payload: ProjectSettingsPayload) => void
}
...
export function ProjectSettingsSheet({
  ...
  return (
    <>
      <Sheet open={open} onOpenChange={(nextOpen) => (nextOpen ? onOpenChange(true) : requestClose())}>
        <SheetContent className="flex w-full flex-col gap-0 sm:max-w-xl">
          <SheetHeader className="border-b px-6 pb-4">
            <SheetTitle>Configuración del proyecto</SheetTitle>
            <SheetDescription>
              Actualizá el nombre, estado, fase actual y fecha objetivo.
            </SheetDescription>
          </SheetHeader>
