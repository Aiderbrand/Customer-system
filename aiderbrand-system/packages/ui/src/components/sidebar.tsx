  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex min-h-svh w-full min-w-0 max-w-full overflow-x-clip has-data-[variant=inset]:bg-sidebar",
          className
        )}
        {...props}
      >
...
function SidebarInset({
  ...
  return (
    <main
      ...
      className={cn(
        "relative flex min-w-0 max-w-full flex-1 flex-col overflow-x-hidden bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className
      )}
      {...props}
    />
...
function SidebarMenuButton({
  ...
  const resolvedTooltip = typeof tooltip === "string"
    ? { children: tooltip }
    : tooltip
